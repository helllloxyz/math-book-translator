...
assert.match(source, />Quiz · 画像</, 'Library cards should expose the dedicated learning workspace')
assert.match(source, />状态</, 'Library cards should expose content status outside the menu')
assert.match(source, />笔记</, 'Library cards should expose notes outside the menu')

...
assert.match(source, /toggleNodeContext/, 'ImportModal should toggle one heading context preview at a time')
assert.match(source, /contextLineNumber/, 'ImportModal should preserve source line numbers in the context preview')
assert.match(source, /node\.context\.heading_line/, 'ImportModal should highlight the selected heading line')

...
assert.match(component, /isSelectedGuideDual\.value \? translatedOrSourceHtml\.value : props\.renderedGuide/, 'guide dual left pane should show the guide content')
assert.match(component, /isSelectedGuideDual\.value \? props\.renderedSource : translatedOrSourceHtml\.value/, 'guide dual right pane should show chapter content')
